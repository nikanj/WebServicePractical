...
service CallbackStudent {
	void notifyQuestion(1:Question question), 
}

service CallbackLecturer {
	void notifySpeedVoting(1:i32 lectureId,2:Speed speedOld,3:Speed speedNew), 
	void notifyPauseVoting(1:i32 lectureId,2:Pause pauseOld,3:Pause pauseNew),
}
