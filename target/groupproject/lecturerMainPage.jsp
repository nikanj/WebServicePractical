...
$(document).ready(function () {
   ...
   var data = [
    ...
    $.plot($("#flotcontainer2"), data, options); 
...
<body>
	...
	<!-- <form action="lecturerViewQuestions" method="post">
		Enter the Number of Questions : <input type="text"
			name="numberOfQuestions"> <input type="submit" value="Submit">
	</form> -->
	...
	<!-- form action="./lecturerUpdate.jsp" method="post">
		<input type="hidden" name="lectureId" value="${lectureId}">
		<input type="submit" value="Update Lecture Here">
	</form -->
</body>
</html>
